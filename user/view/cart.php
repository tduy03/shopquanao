        ...
        <div class="cart-content row">
                            ...
                            <tr>
                                ...
                                <td><h3 style="font-size: smaller;">'.$item[2].'</h3>
                                    ...
                                    <div class="cart-price">
                                        <p>'. number_format($item[4]).'<sup>đ</sup> 
                                        <span>'.number_format($item[5]).'<sup>đ</sup></span></p>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td><p style="color:rgb(178, 0, 0); font-weight: bold;">'.number_format($tt) .'<sup>đ</sup></p></td>
            ...
            <div class="cart-content-right">
                <table>
                    ...
                    <tr>
                        <td>TỔNG SẢN PHẨM:</td>
                        <td><?php echo isset($_SESSION['giohang']) ? count($_SESSION['giohang']) : 0; ?></td>
                    </tr>
                    <tr>
                        <td>TỔNG TIỀN HÀNG:</td>
                        <td><p id="total-price"><?php echo number_format($tong)  ?><sup>đ</sup></p></td>
                    </tr>
                    <tr>
                        <td>TẠM TÍNH:</td>
                        <td><p id="subtotal" style="color:black; font-weight: bold;"><?php echo number_format($tong) ?><sup>đ</sup></p></td>
                    </tr>
                </table>
